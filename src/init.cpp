...
{
    const std::string URL_SOURCE_CODE = "<https://github.com/faircoin/faircoin>";
    const std::string URL_WEBSITE = "<https://faircoin.com>";

    return CopyrightHolders(strprintf(_("Copyright (C) %i-%i"), 2009, COPYRIGHT_YEAR) + " ") + "\n" +
           strprintf(_("Copyright (C) %i The FairCoin developers"), COPYRIGHT_YEAR) + "\n" +
           "\n" +
